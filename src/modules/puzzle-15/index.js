...
export const puzzle15Run = (puzzle15Win, brandType) => {
  console.log("RUN PUZZLE");
  // запуск игры
  const game = new Game(document.querySelector(".puzzle__board"), brandType);
  ...
  window.addEventListener(
    ...
    (e) => {
      ...
      if (code === 27 && app.keysBlocked) {
        app.closeInfo();
      } // 'Esc'

      if (!app.keysBlocked && code >= 37 && code <= 40) {
        game.trigger(code);
      }
    },
    false
